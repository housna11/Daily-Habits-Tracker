...
function UserCard({ user, onDeleteRoutine, onToggleFait }) { 
  ...
  return (
    <div className='bg-white w-[310px] rounded-md flex flex-col items-center justify-start pt-5
                shadow-md hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1'   style={{ boxShadow: '0 4px 6px rgba(21, 122, 134, 0.5)' }}
>
      <div className="mb-6 flex flex-col items-center">
        ...
        <div className="w-[250px] bg-gray-200 rounded-full h-2.5 mt-2">
          <div
            className= "bg-[#157A86] h-2.5 rounded-full"
